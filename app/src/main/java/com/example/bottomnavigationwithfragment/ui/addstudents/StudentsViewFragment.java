...
public class StudentsViewFragment extends Fragment implements RadioGroup.OnCheckedChangeListener,View.OnClickListener{
    ...
    public static StudentsViewFragment newInstance() {
